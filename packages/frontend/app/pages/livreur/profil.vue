                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <Input
                                id="email"
                                type="email"
                                default-value="driver@transvirex.fr"
                            />
                        </div>
                        <div class="space-y-1.5">
                ...
                <CardContent>
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-muted-foreground">
                                AA-123-BB · Hub Paris Centre
                            </p>
                        </div>
                        <Badge
                            class="ml-auto bg-green-100 text-green-700 border-green-200 hover:bg-green-100"
                            >Actif</Badge
                        >
                    </div>
                </CardContent>
