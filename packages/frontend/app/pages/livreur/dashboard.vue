            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
                <Card class="xl:col-span-2">
                    ...
                    <CardContent>
                        <div class="relative">
                            <div
                                class="absolute left-4 top-3 bottom-3 w-0.5 bg-border"
                            />
                            <div
                ...
                <div class="space-y-4">
                    <Card>
                        <CardHeader
                            class="flex-row items-center gap-2 space-y-0 pb-3"
                        >
                            <div
                    ...
                    <Card>
                        <CardContent class="p-4">
                            ...
                            <div
                                class="flex items-center justify-between bg-yellow-50 rounded-lg px-3 py-2"
                            >
...
const driverFirstName = computed(
    () => (payload.value?.firstname as string) || 'Pierre',
);
